...
__declspec(align(16)) struct HitResult
{
	bool isHitted;
...
__declspec(align(16)) struct Sphere :public Collision
{
...
__declspec(align(16)) struct Plane :public Collision
{
...
__declspec(align(16)) struct AABB :public Collision
{
